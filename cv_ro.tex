...
\cvlistitem{Cursul de dezvoltare liberă (CDL) - cursant și mentor la proiectul DEX Online (2011)}
\cvlistitem{Organizator și coordonator ROSEdu Summer Workshops, prima ediție (2012)}
\cventry{2011 -- prezent}{InGeAR - centrul de Inginerie Electrică, Automatizări și Robotică}{Universitatea Politehnica București}{}{}{}
...
\cvcomputer{Sisteme de operare}{Windows, Linux}{Distribuție Linux}{Debian based}
...
\cvlistitem{Proiectarea și programarea microcontrollerelor}
\cvlistitem{Calcul numeric}
